    ...
    <div className="App">
      <header className="App-header">
        <div style={{
          ...
          <Link to ="/" style={{ color: 'blue', textDecoration: 'underline', marginRight: "50px"}}> home </Link>
          <Link to ="/gallery" style={{ color: 'blue', textDecoration: 'underline', marginRight: "50px" }}> Gallery Panel </Link>
