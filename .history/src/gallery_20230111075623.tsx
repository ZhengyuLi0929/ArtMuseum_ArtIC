...
export default function GalleryView(){
    ...
    return(
        <div>
            ...
            <button value = "michelangelo" onClick = {handleArtists}>Michelangelo</button>
            <button value = "manet" onClick = {handleArtists}>Manet</button>
            <button value = "matisse" onClick = {handleArtists}>Matisse</button>
            <button value = "pollock" onClick = {handleArtists}>Pollock</button>
            <button value = "dali" onClick = {handleArtists}>Dali</button>
            <button value = "warhol" onClick = {handleArtists}>Warhol</button>
            <button value = "klimt" onClick = {handleArtists}>Klimt</button>
            <button value = "turner" onClick = {handleArtists}>Turner</button>
            <button value = "cezanne" onClick = {handleArtists}>Cezanne</button>
            <div>
            {
